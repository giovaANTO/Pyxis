...
public final class PowerupEffectFactoryImpl implements PowerupEffectFactory {
    ...
    /**
     * Create a new generic {@link PowerupEffect}.
     * @param type
     *              The {@link PowerupEffectType} of effect to create.
     * @param apply
     *              A {@link Consumer<Arena>} used for apply the effect.
     * @param remove
     *              A {@link Consumer<Arena>} used for remove the previously applied effect.
     * @param time
     *              The effect application time in seconds.
     * @return
     *              A new instance of {@link PowerupEffect}.
     */
